...
if not load:
  ...
  print('dump')
  with open(f'max-input-{sys.argv[-2]}', 'wb') as f:
    pickle.dump(input, f)
  print('dump')
  with open(f'max-labels-{sys.argv[-2]}', 'wb') as f:
    pickle.dump(labels, f)
  print('dump')
  with open(f'max-elastlicsearch_idxs-{sys.argv[-2]}', 'wb') as f:
    pickle.dump(elasticsearch_idxs, f)
else:
  print('load')
  with open(f'max-input-{sys.argv[-2]}', 'rb') as f:
    input = pickle.load(f)
  print('load')
  with open(f'max-labels-{sys.argv[-2]}', 'rb') as f:
    labels = pickle.load(f)
  print('load')
  with open(f'max-elastlicsearch_idxs-{sys.argv[-2]}', 'rb') as f:
...
out_MAP_inner = []
ranksvm_outer_dir = f'tmp-skip-{sys.argv[-2]}/ranksvm-top-{top_n}'
...
with open('results-final.tsv', 'a') as f:
  f.write(f'SVM-skip-{top_n}-{sys.argv[-2]}\n')
  f.write(out)

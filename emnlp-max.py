...
out_MAP_inner = []
ranksvm_outer_dir = f'tmp-max-{sys.argv[-2]}/ranksvm-top-{top_n}'
...
#   f.write(f'SVM-max-{top_n}-{sys.argv[-2]}\n')
#   f.write(out)
